...
\addplot table [x=NumberOfComponents, y=ButtonsCPU(UIKit), col sep=comma, meta=ButtonsCPU(UIKit)] {\datatable};
\addlegendentry{UIKit}

\addplot table [x=NumberOfComponents, y=ButtonsCPU(SwiftUI), col sep=comma, meta=ButtonsCPU(SwiftUI)] {\datatable};
