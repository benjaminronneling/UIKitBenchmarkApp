...
\addplot table [x=NumberOfComponents, y=TypicalAppCPU(UIKit), col sep=comma, meta=TypicalAppCPU(UIKit)] {\datatable};
\addlegendentry{UIKit}

\addplot table [x=NumberOfComponents, y=TypicalAppCPU(SwiftUI), col sep=comma, meta=TypicalAppCPU(SwiftUI)] {\datatable};
