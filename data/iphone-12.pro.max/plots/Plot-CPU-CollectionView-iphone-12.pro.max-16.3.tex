...
\addplot table [x=NumberOfComponents, y=CollectionViewCPU(UIKit), col sep=comma, meta=CollectionViewCPU(UIKit)] {\datatable};
\addlegendentry{UIKit}

\addplot table [x=NumberOfComponents, y=CollectionViewCPU(SwiftUI), col sep=comma, meta=CollectionViewCPU(SwiftUI)] {\datatable};
