...
\addplot table [x=NumberOfComponents, y=ImagesCPU(UIKit), col sep=comma, meta=ImagesCPU(UIKit)] {\datatable};
\addlegendentry{UIKit}

\addplot table [x=NumberOfComponents, y=ImagesCPU(SwiftUI), col sep=comma, meta=ImagesCPU(SwiftUI)] {\datatable};
