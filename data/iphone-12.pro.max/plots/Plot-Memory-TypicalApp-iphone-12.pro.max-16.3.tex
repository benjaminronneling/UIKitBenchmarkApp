...
\begin{tikzpicture}
\begin{axis}[
    title=Plot of scenario \textbf{TypicalApp} on \textbf{\plotTitle}, % Set the title to the table name read from the CSV file
...
\addplot table [x=NumberOfComponents, y=TypicalAppMemory(UIKit), col sep=comma, meta=TypicalAppMemory(UIKit)] {\datatable};
\addlegendentry{UIKit}

\addplot table [x=NumberOfComponents, y=TypicalAppMemory(SwiftUI), col sep=comma, meta=TypicalAppMemory(SwiftUI)] {\datatable};
