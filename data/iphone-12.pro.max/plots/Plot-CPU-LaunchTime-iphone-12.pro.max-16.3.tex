...
\addplot table [x=NumberOfComponents, y=LaunchTimeCPU(UIKit), col sep=comma, meta=LaunchTimeCPU(UIKit)] {\datatable};
\addlegendentry{UIKit}

\addplot table [x=NumberOfComponents, y=LaunchTimeCPU(SwiftUI), col sep=comma, meta=LaunchTimeCPU(SwiftUI)] {\datatable};
