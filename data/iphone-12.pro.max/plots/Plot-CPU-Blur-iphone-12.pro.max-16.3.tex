...
\addplot table [x=NumberOfComponents, y=BlurCPU(UIKit), col sep=comma, meta=BlurCPU(UIKit)] {\datatable};
\addlegendentry{UIKit}

\addplot table [x=NumberOfComponents, y=BlurCPU(SwiftUI), col sep=comma, meta=BlurCPU(SwiftUI)] {\datatable};
