...
\begin{tikzpicture}
\begin{axis}[
    title=Plot of scenario \textbf{LaunchTime} on \textbf{\plotTitle}, % Set the title to the table name read from the CSV file
...
\addplot table [x=NumberOfComponents, y=LaunchTimeMemory(UIKit), col sep=comma, meta=LaunchTimeMemory(UIKit)] {\datatable};
\addlegendentry{UIKit}

\addplot table [x=NumberOfComponents, y=LaunchTimeMemory(SwiftUI), col sep=comma, meta=LaunchTimeMemory(SwiftUI)] {\datatable};
