...
\addplot table [x=NumberOfComponents, y=TextCPU(UIKit), col sep=comma, meta=TextCPU(UIKit)] {\datatable};
\addlegendentry{UIKit}

\addplot table [x=NumberOfComponents, y=TextCPU(SwiftUI), col sep=comma, meta=TextCPU(SwiftUI)] {\datatable};
